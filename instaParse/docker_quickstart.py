...
insta_username = 'vlasov.evgeny'
insta_password = '3004990q'
...
bot.like_by_tags(['algorithms', 'programming', 'machine_learning', 'data science','data_science'], amount=500)
bot.follow_by_tags(['data science', 'math','science','books','algorithm'], amount=200)
bot.end()
